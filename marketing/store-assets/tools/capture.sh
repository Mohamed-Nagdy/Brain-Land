...
# Usage: tools/capture.sh <device-id> <android-phone|android-tablet|ios-iphone69|ios-ipad13> <ar|en> "<device description>"
set -euo pipefail
...
flutter drive --driver test_driver/integration_test.dart --target integration_test/app_test.dart \
  -d "$device" --dart-define=LANG="$locale" --dart-define=DEVICE="$target" --dart-define=BRAINLAND_NO_ADS=true
