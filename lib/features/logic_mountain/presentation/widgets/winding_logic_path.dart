...
/// Winding path widget for Logic Mountain level selection
        ...
        return SingleChildScrollView(
          ...
          child: CustomPaint(
            painter: PathPainter(
              ...
              itemHeight: 120.0,
              pathColor: const Color(0xFFBA68C8), // Purple
...
class PathPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Draw puzzle pieces along the path
    ...
    for (int i = 0; i < itemCount; i += 3) {
      ...
      canvas.drawCircle(Offset(x, y), 4, piecePaint);
    }
  }
