...
part of 'math_level.dart';

// **************************************************************************
// TypeAdapterGenerator
// **************************************************************************

class MathLevelAdapter extends TypeAdapter<MathLevel> {
  @override
  final int typeId = 17;

  @override
  MathLevel read(BinaryReader reader) {
  ...
  @override
  void write(BinaryWriter writer, MathLevel obj) {
    writer
      ..writeByte(9)
      ..writeByte(0)
      ..write(obj.id)
