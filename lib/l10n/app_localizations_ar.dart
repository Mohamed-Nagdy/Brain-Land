...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get aboutAds =>
      'تعرض هذه النسخة المجانية بعض الإعلانات بين المهام، ولا تعرضها أثناء اللغز أبدًا. تُطلب الإعلانات كإعلانات موجّهة للأطفال: دون تخصيص للإعلانات ودون معرّف إعلاني.';
